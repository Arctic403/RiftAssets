...
const MODEL_APARTMENT=Object.freeze({
  id:'apartment-03f-01',
  name:'3-Storey Apartment — Mesh Proof',
  category:'Buildings',
  description:'Real glTF proof asset: chamfered masonry shell, recessed framed windows, modeled balconies/rails, rooftop equipment, side/rear detail and fire escape geometry.',
  cameraRadius:24,
  modelUrl:'./assets/models/apartment-proof-01.gltf',
  modelFormat:'gltf',
  proofModel:true,
  modelStats:{vertices:5078,triangles:8936,materialGroups:10}
});

const finalAssets=assets.map(asset=>asset.id===MODEL_APARTMENT.id?MODEL_APARTMENT:asset);
